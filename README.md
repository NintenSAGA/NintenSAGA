...
| `MIT 6.824`, **_Distributed System_**, Spring 2022             | `MapReduce[1/1]`<br />`Raft[4/4]`<br />`KV-Raft[2/2]`<br />`ShardedKV[2/2] (with 2 challenges)` | ✅         |
| `NJUCS`, **_Static Program Analysis_**, Fall 2022              | `Tai-e A[3/8]`                       |          |
